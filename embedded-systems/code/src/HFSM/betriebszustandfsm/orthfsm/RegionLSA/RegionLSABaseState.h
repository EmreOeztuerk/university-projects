/**
 * @file RegionLSABaseState.h
 * @author Alaa Al-Sowmali, Marta Muñoz Merino, Emre Öztürk
 * @date 20.01.2026
 * @version 1.0
 * @brief Basisklasse für alle Zustände in der orthogonalen Region LSA.
 *
 * Diese Region verwaltet den Einlaufbereich des Förderbands (Lichtschranke Anfang).
 */

#ifndef REGIONLSABASESTATE_H
#define REGIONLSABASESTATE_H
...
/**
 * Orthogonale Region "LSA" im Composite-State Sortierung.
 */
class RegionLSABaseState {
protected:
    ContextData *data;
    Actions *action;

public:
    virtual ~RegionLSABaseState() {
    };
    ...
    /*  // Events, die in dieser Region relevant sind
    virtual TriggerProcessingState s_lsa_ub()      { return TriggerProcessingState::pending; }
