/**
 * @file RegionLSWBisLSEBaseState.h
 * @author Alaa Al-Sowmali, Marta Muñoz Merino, Emre Öztürk
 * @date 20.01.2026
 * @version 1.0
 * @brief Basisklasse für die Region LSW bis LSE.
 *
 * Diese Region steuert den Transportabschnitt von der Weiche (LSW) bis zum Bandende (LSE).
 */

#ifndef ESEP_2025WISE_TEAM_1_3_REGIONLSWBISLSEBASESTATE_H
#define ESEP_2025WISE_TEAM_1_3_REGIONLSWBISLSEBASESTATE_H
...
class RegionLSWBisLSEBaseState {
protected:
    ContextData *data;
    Actions *action;

public:
    virtual ~RegionLSWBisLSEBaseState() {
    };
...
#endif //ESEP_2025WISE_TEAM_1_3_REGIONLSWBISLSEBASESTATE_H