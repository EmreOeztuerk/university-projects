...
public:
	...
	*************************************************************************/
    ...
    void tsStepConfig(unsigned int stepSelect, NegativeRef adcNegativeRef, PositiveInput adcPositiveInp,
    ...
    void clearBitsInReg(int addr, int ctr_tsc);

    void setBitsInReg(int addr, int ctr_tsc);
